  ...
  function buildBanner() {
    ...
    if (IS_MODERN) {
      el.innerHTML = [
        ...
        '  <p class="cb-body">Wij gebruiken analytische cookies (Google Analytics) om bezoekersgedrag te begrijpen en functionele cookies voor het intakeformulier (Supabase). Jij bepaalt wat je toestaat.</p>',
        '  <div class="cb-toggles">',
        '    <label class="cb-toggle"><input type="checkbox" id="cb-analytics" checked> <span>Analytisch (GA)</span></label>',
        '    <label class="cb-toggle"><input type="checkbox" id="cb-functional" checked> <span>Functioneel (Supabase)</span></label>',
        '  </div>',
      ...
      el.innerHTML = [
        ...
        '    <ul>',
        '      <li><label><input type="checkbox" id="cb-analytics" checked> Analytische cookies (Google Analytics)</label></li>',
        '      <li><label><input type="checkbox" id="cb-functional" checked> Functionele cookies (Supabase formulier)</label></li>',
        '    </ul>',
        '  </div>',
